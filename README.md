[![GitHub release](https://img.shields.io/github/release/crazy-max/neard-bin-mailhog.svg?style=flat-square)](https://github.com/crazy-max/neard-bin-mailhog/releases/latest)
